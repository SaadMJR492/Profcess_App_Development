...
USERTYPE_CHOICES =ProfcessUser.USERTYPE_CHOICES
...
class RecruiterCreationForm(forms.ModelForm):
    ...
    is_termnsandconditions=forms.BooleanField(error_messages={'required':'You must accept terms and conditions'},label="Terms&Conditions")

    class Meta:
        model = ProfcessUser
        fields = ("username", "email", "first_name", "last_name", "phone", "company_name","is_termnsandconditions")#,"designation","location","url_of_company","why_join_us","company_description",)
...
class ApplicantCreationForm(forms.ModelForm):
    ...
    is_termnsandconditions = forms.BooleanField(error_messages={'required': 'You must accept terms and conditions'},
                                                label="Terms&Conditions")

    class Meta:
        model = ProfcessUser
        fields = ("username", "email","first_name","last_name", "email","phone","college_name_stu","is_termnsandconditions")
...
class CollegeCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = ProfcessUser
        fields = ("username", "email", "first_name", "last_name", "phone", "college_name","url_of_college","college_description","is_termnsandconditions")#,"designation","location","url_of_college","why_join_us","college_description",)
...
class CFormFooter(forms.ModelForm):
    model=ProfcessUser
    class Meta:
        model=ProfcessUser
        fields = ('uname','mail','telephone','message',)
...
class Form1(forms.ModelForm):
    ...
    usertype = forms.CharField(label=_("usertype"),
                      max_length=10,
    ...
    class Meta:
        model = ProfcessUser
        fields = ("username", "email", "usertype")#,"designation"","location","url_of_company","why_join_us","company_description",)
